...
/*
interpolates x values between the y values of the points
params
p0 - first point
p1 - second point
return
out - the x values of the line between the two points
*/
...
/*
generates a filled triangle in the texture array based on three points
params
points_ - the points to generate the triangle
texture[] - the texture to write the triangle to
width - the length of the texture side
return
*/
